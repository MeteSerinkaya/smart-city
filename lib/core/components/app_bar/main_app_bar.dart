...
class MainAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  const MainAppBar({super.key, this.onNavTap, this.isTransparent = true, this.scrollController, this.scrollProgress});
...
class _MainAppBarState extends State<MainAppBar> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin {
  ...
  void _onScroll() {
    ...
    // Scroll offset tracking removed
  }
            ...
            child: ClipRRect(
              ...
              child: Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  return const Icon(Icons.location_city, color: Colors.white, size: 24);
                },
              ),
            ),
          ),
...
class ResponsiveNavigationWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayItems = isTablet
        ? _MainAppBarState._navItems
    ...
    return Semantics(
      ...
      child: Container(
        decoration: const BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Color(0x3300A8E8), blurRadius: 8, offset: Offset(0, 2))],
        ),
            ...
            return AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: widget.selected
                    ? (widget.isTransparent ? Colors.white.withOpacity(0.2) : Colors.black.withOpacity(0.1))
                    : hovered
                    ? (widget.isTransparent ? Colors.white.withOpacity(0.1) : Colors.black.withOpacity(0.05))
                    : Colors.transparent,
                borderRadius: BorderRadius.circular(widget.isCompact ? 8 : 12),
                border: widget.selected
                    ? Border.all(
                        color: widget.isTransparent ? Colors.white : Colors.black,
